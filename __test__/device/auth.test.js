...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Morgan.Weber59',
      password: '7iVzdJiXIrVKXbU',
      email: 'Chyna_Ziemann@gmail.com',
      ...
      userType: 416,
      mobileNo: '(439) 712-2421',
      resetPasswordLink: {},
      loginRetryLimit: 995,
      loginReactiveTime: '2024-08-27T13:33:56.443Z',
      id: '65a815181504cd0486c4f214'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Noah_Frami',
        'password':'KdnHrfyj8G1s0vq',
        'email':'Carol17@gmail.com',
        'name':'Luz Boehm',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Granite',

...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Edna.Mueller',
      password: 'jao8yY1IJrJ6Yhu',
      email: 'Kristoffer58@gmail.com',
      name: 'Dr. Camille Williamson',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Oregon',
      ...
      userType: 705,
      mobileNo: '(343) 780-7391',
      resetPasswordLink: {},
      loginRetryLimit: 878,
      loginReactiveTime: '2024-09-11T11:02:54.934Z',
      id: '65a815181504cd0486c4f1a8'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Tiffany17',
        'password':'jvywdpkqX8Pkd10',
        'email':'Precious_Grant@yahoo.com',
        'name':'Lucas Turner',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Borders',
          'address1':'open-source',
          'address2':'Walk',
          'landmark':'interface',
          'city':'Frozen',
          'isDefault':true,
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Precious_Grant@yahoo.com', });

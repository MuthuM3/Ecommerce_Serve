...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Hugh36',
      password: 'R2jst2Zpq1VmI9B',
      email: 'Vella_Treutel74@gmail.com',
      name: 'Alice Dach',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 155,
      mobileNo: '(543) 034-4017',
      resetPasswordLink: {},
      loginRetryLimit: 569,
      loginReactiveTime: '2024-03-29T17:31:15.790Z',
      id: '65a815181504cd0486c4f280'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Vivienne98',
        'password':'YIYOcNANKhuNecK',
        'email':'Kali_Hoppe88@hotmail.com',
        'name':'Ignacio Dach',
        'shippingAddress':[{
          '_id':false,
          'pincode':'(Slovak',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Kali_Hoppe88@hotmail.com', });
